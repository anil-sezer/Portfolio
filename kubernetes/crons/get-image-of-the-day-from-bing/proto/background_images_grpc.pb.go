...
type BackgroundImagesClient interface {
	Persist(ctx context.Context, in *BackgroundImageDetails, opts ...grpc.CallOption) (*emptypb.Empty, error)
	Get(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*BackgroundImageDetails, error)
}
...
func (c *backgroundImagesClient) Persist(ctx context.Context, in *BackgroundImageDetails, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *backgroundImagesClient) Get(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*BackgroundImageDetails, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BackgroundImageDetails)
...
type BackgroundImagesServer interface {
	Persist(context.Context, *BackgroundImageDetails) (*emptypb.Empty, error)
	Get(context.Context, *emptypb.Empty) (*BackgroundImageDetails, error)
...
func (UnimplementedBackgroundImagesServer) Persist(context.Context, *BackgroundImageDetails) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Persist not implemented")
}
func (UnimplementedBackgroundImagesServer) Get(context.Context, *emptypb.Empty) (*BackgroundImageDetails, error) {
...
func _BackgroundImages_Persist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackgroundImagesServer).Persist(ctx, req.(*BackgroundImageDetails))
	}
...
func _BackgroundImages_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackgroundImagesServer).Get(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
